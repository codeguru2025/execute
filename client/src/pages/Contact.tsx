      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <AnimatedSection>
              <p className="text-[#568F69] text-sm tracking-[0.2em] uppercase mb-6">
                Contact Us
              </p>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  <MapPin className="w-5 h-5 text-[#B8D0C0] mt-1 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <Mail className="w-5 h-5 text-[#B8D0C0] mt-1 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <Phone className="w-5 h-5 text-[#B8D0C0] mt-1 flex-shrink-0" />
                  <div>
            ...
            <AnimatedSection delay={0.2}>
              {submitted ? (
                ...
                >
                  <div className="w-16 h-16 bg-[#B8D0C0]/10 rounded-full mx-auto mb-6 flex items-center justify-center">
                    <Check className="w-8 h-8 text-[#B8D0C0]" />
                  </div>
                  ...
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <Button
                        type="submit"
                        disabled={mutation.isPending}
                        className="w-full bg-[#B8D0C0] text-[#0F0F0F] hover:bg-[#568F69] hover:text-white font-semibold disabled:opacity-70"
